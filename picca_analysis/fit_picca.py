...
b_values =      {'G': ls(1.000,1.000,1), 'D': ls(1.0,1.0,1), 'F': ls(1.0,2.0,2), 'q': ls(3.356,3.356,1)}
beta_values =   {'G': ls(0.511,0.511,1), 'D': ls(0.0,0.0,1), 'F': ls(0.0,2.0,2), 'q': ls(0.000,0.000,1)}
