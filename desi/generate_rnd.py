...
def generate_rnd(factor=3, out_path= None, method='use_catalog', catalog_path= None):
    ...
    return None
# Execute
generate_rnd(factor=10,out_path='/global/projecta/projectdirs/desi/mocks/lya_forest/london/v4.0.0/master_randoms.fits.gz',method='use_catalog', catalog_path='/global/projecta/projectdirs/desi/mocks/lya_forest/london/v4.0.0/master.fits')
