...
if (args.qq_basedir is not None) and (args.qq_runs is not None):
    for qq_run in args.qq_runs:
        ...
        command = '/global/homes/j/jfarr/Projects/LyaCoLoRe/etc/batch_analysis/run_make_deltas.py --slurm-script {} --out-dir {} --deltas-dir {} --region-name lya --drq {} --in-dir {} --lambda-rest-min 1040.0 --lambda-rest-max 1200.0'.format('run_picca_deltas_lyaregion.sl',analysis_dir.datadir,analysis_dir.lyadeltadirname,drq,in_dir)
        call(command.split(' '))
        print('')
        ...
        command = '/global/homes/j/jfarr/Projects/LyaCoLoRe/etc/batch_analysis/run_make_deltas.py --slurm-script {} --out-dir {} --deltas-dir {} --region-name lyb --drq {} --in-dir {} --lambda-rest-min 920.0 --lambda-rest-max 1020.0'.format('run_picca_deltas_lybregion.sl',analysis_dir.datadir,analysis_dir.lybdeltadirname,drq,in_dir)
        call(command.split(' '))
        print('')
...
if args.raw_dir is not None:
    ...
    drq = os.path.join(analysis_dir.objdir,'drq_qso.fits')
    in_dir = args.raw_dir
    command = '/global/homes/j/jfarr/Projects/LyaCoLoRe/etc/batch_analysis/run_make_raw_deltas.py --slurm-script {} --python-script {} --out-dir {} --deltas-dir {} --region-name lya --drq {} --in-dir {} --lambda-rest-min 1040.0 --lambda-rest-max 1200.0'.format('run_picca_raw_deltas_lyaregion.sl','run_picca_raw_deltas_lyaregion.py',analysis_dir.datadir,analysis_dir.lyadeltadirname,drq,in_dir)
    call(command.split(' '))
    print('')
    ...
    command = '/global/homes/j/jfarr/Projects/LyaCoLoRe/etc/batch_analysis/run_make_raw_deltas.py --slurm-script {} --python-script {} --out-dir {} --deltas-dir {} --region-name lyb --drq {} --in-dir {} --lambda-rest-min 920.0 --lambda-rest-max 1020.0'.format('run_picca_raw_deltas_lybregion.sl','run_picca_raw_deltas_lybregion.py',analysis_dir.datadir,analysis_dir.lybdeltadirname,drq,in_dir)
    call(command.split(' '))
    print('')
