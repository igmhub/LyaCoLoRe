...
def measure_pixel_segment(pixel,C0,C1,C2,D0,D1,D2,n,k1,RSD_weights,prep=False):
    ...
    if prep:
        ...
        for z_value in z_values:
            ...
            measurement.add_Pk1D_chi2(max_k=max_k,denom="npower")
...
tasks = [(pixel,3.,0.,0.,7.,0.,0.,1.52,0.0166,None,True) for pixel in pixels]
...
plot_parameter_values(minuit,show_plot=show_plots)
