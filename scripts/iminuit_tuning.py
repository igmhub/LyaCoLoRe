...
t_kwargs = {'alpha' : 2.28,    'error_alpha' : 0.05,   'limit_alpha' : (0., 10.),  'fix_alpha' : False,
...
s_kwargs = {'n'  : 1.48,       'error_n' : 0.05,       'limit_n' : (0., 10.),      'fix_n' : True, #0.9157
            'k1' : 0.0162,    'error_k1' : 0.00005,   'limit_k1' : (0., 0.1),     'fix_k1' : True, #0.003464
