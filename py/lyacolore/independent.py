...
def get_gaussian_fields(generator,N_cells,power_obj,z=0.0,dv_kms=10.0,N_skewers=1,white_noise=False,A0=58.6,R_kms=25.0,norm=True,remove_P1D_data=None,remove_P1D_amp=None):
    ...
    P_kms = power_kms(z,k_kms,dv_kms,power_obj,A0=A0,R_kms=R_kms,smooth=True,norm=norm)
...
#Function to return a gaussian P1D in k.
#From lya_mock_functions
def power_kms(z_c,k_kms,dv_kms,power_obj,white_noise=False,A0=58.6,R_kms=25.0,smooth=True,norm=False):
    ...
    """
    if white_noise:
        return np.ones_like(k_kms)*100.0
