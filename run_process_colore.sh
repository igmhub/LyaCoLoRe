...
INPUT_PATH="/global/cscratch1/sd/jfarr/LyaSkewers/CoLoRe_GAUSS/output_G_hZ_${NGRID}_${NODES}_sr${R_SMOOTH}_bm1_biasG18_picos/"
echo "input will be taken from "$INPUT_PATH

# full path to folder where output will be written
OUTPUT_PATH="/global/cscratch1/sd/jfarr/LyaSkewers/CoLoRe_GAUSS/process_output_G_hZ_${NGRID}_${NODES}_sr${R_SMOOTH}_bm1_biasG18_picos_nside${NSIDE}/"
...
RUN_FILE="/global/homes/j/jfarr/Projects/LyaCoLoRe/run_files/process_colore_output_hZ_${NGRID}_${NODES}_sr${R_SMOOTH}_bm1_biasG18_picos.sh"
